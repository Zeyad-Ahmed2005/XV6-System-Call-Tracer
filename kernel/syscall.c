...
// Index 0 unused; entries follow SYS_* order (positional init avoids C++
// parsers / MSVC IntelliSense rejecting C99 [SYS_…] designated initializers).
